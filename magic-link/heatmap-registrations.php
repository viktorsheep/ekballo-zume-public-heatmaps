...
if ( strpos( dt_get_url_path(), 'zume_app' ) !== false || dt_is_rest() ){
    DT_Network_Dashboard_Public_Heatmap_Registrations::instance();
}
...
class DT_Network_Dashboard_Public_Heatmap_Registrations extends DT_Network_Dashboard_Public_Heatmap_Churches
{
    ...
    public function _browser_tab_title( $title ){
        return __( "Zúme Registrations Map", 'disciple_tools' );
    }

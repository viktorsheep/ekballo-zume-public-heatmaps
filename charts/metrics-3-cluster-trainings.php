...
class Zume_Public_Heatmaps_Metrics_Cluster_Trainings extends DT_Metrics_Chart_Base
{
    ...
    public function __construct() {
        $this->magic_link = site_url() . '/zume_app/cluster_trainings/';
        parent::__construct();
...
Zume_Public_Heatmaps_Metrics_Cluster_Trainings::instance();

...
class Zume_Public_Heatmaps_Metrics_Map_Last100 extends DT_Metrics_Chart_Base
{
    ...
    public function __construct() {
        $this->magic_link = site_url() . '/zume_app/last100_hours/';
        parent::__construct();
...
Zume_Public_Heatmaps_Metrics_Map_Last100::instance();

...
class Zume_Public_Stats_Churches_Metrics extends DT_Metrics_Chart_Base
{
    public $base_slug = 'zume-public-heatmaps';
    public $base_title = "Public Maps";

    public $title = 'Church Stats';
    public $slug = 'churches-stats';
    ...
    public function __construct() {
        $this->magic_link = site_url() . '/zume_app/stats_churches/';
        parent::__construct();
...
Zume_Public_Stats_Churches_Metrics::instance();

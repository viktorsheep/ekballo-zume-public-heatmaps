...
class Zume_Public_Heatmaps_Metrics_Map_Registrations extends DT_Metrics_Chart_Base
{
    public $base_slug = 'zume-public-heatmaps';
    public $base_title = "Public Maps";

    public $title = 'Registrations Saturation Map';
    public $slug = 'registrations-saturation-map';
    ...
    public function __construct() {
        $this->magic_link = site_url() . '/zume_app/heatmap_registrations/';
        parent::__construct();
...
Zume_Public_Heatmaps_Metrics_Map_Registrations::instance();

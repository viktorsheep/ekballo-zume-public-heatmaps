...
class Zume_Public_Stats_Trainings_Metrics extends DT_Metrics_Chart_Base
{
    public $base_slug = 'zume-public-heatmaps';
    public $base_title = "Public Maps";

    public $title = 'Trainee Stats';
    public $slug = 'trainee-stats';
    ...
    public function __construct() {
        $this->magic_link = site_url() . '/zume_app/stats_trainings/';
        parent::__construct();
...
Zume_Public_Stats_Trainings_Metrics::instance();

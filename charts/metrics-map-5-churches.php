...
class Zume_Public_Heatmaps_Metrics_Map_Churches extends DT_Metrics_Chart_Base
{
    public $base_slug = 'zume-public-heatmaps';
    public $base_title = "Public Maps";

    public $title = 'Churches Saturation Map';
...
Zume_Public_Heatmaps_Metrics_Map_Churches::instance();

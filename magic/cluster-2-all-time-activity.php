...
if ( strpos( dt_get_url_path(), 'zume_app' ) !== false || dt_is_rest() ){
    Zume_Public_Heatmaps_Cluster_Activity::instance();
}

/**
 * Class Disciple_Tools_Plugin_Starter_Template_Magic_Link
 */
class Zume_Public_Heatmaps_Cluster_Activity extends DT_Magic_Url_Base {

    public $magic = false;
    public $parts = false;
    public $page_title = 'All Time Activity';
    public $root = "zume_app";
    public $type = 'cluster_activity';

...
<div class="off-canvas-wrapper">
    ...
    <div class="off-canvas position-left" id="offCanvasLeft" data-off-canvas data-transition="push">
        ...
        <div class="grid-x grid-padding-x center">
            ...
            <div class="cell"><a href="<?php echo site_url() . '/' . $this->parts['root'] . '/' . $this->parts['type'] . '/' . $this->parts['public_key'] . '/' ?>"><h3>via List</h3></a></div>
            <div class="cell"><a href="<?php echo site_url() . '/' . $this->parts['root'] . '/' . $this->parts['type'] . '/' . $this->parts['public_key'] . '/map' ?>"><h3>via Map</h3></a></div>
            <br><br>

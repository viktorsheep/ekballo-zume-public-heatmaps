...
if ( strpos( dt_get_url_path(), 'zume_app' ) !== false || dt_is_rest() ){
    Zume_Public_Heatmap_Churches_1000_v2::instance();
}

class Zume_Public_Heatmap_Churches_1000_v2 extends DT_Magic_Url_Base
{
    public $page_title = 'Zúme Churches Map';
    public $root = "zume_app";
    public $type = 'heatmap_1000_v2';
    public $type_name = '';
    ...
    public function endpoint( WP_REST_Request $request ) {
        ...
        switch ( $action ) {
            ...
            case 'a0':
            case 'world':
                $list = Zume_App_Heatmap::query_church_grid_totals_v2( $action );
